...
// MsFPOP_cpp
List MsFPOP_cpp(std::vector<double> y, double beta, double alpha, std::string sampling_method, int sampling_method_parameter, std::vector<double> wt);
RcppExport SEXP _MsFPOP_MsFPOP_cpp(SEXP ySEXP, SEXP betaSEXP, SEXP alphaSEXP, SEXP sampling_methodSEXP, SEXP sampling_method_parameterSEXP, SEXP wtSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(MsFPOP_cpp(y, beta, alpha, sampling_method, sampling_method_parameter, wt));
...
static const R_CallMethodDef CallEntries[] = {
    {"_MsFPOP_MsFPOP_cpp", (DL_FUNC) &_MsFPOP_MsFPOP_cpp, 6},
